...
//        return locations.findLocation(id).orElseThrow(() -> new ResponseStatusException(HttpStatus.NOT_FOUND));
//    }
//
//    @PostMapping
...
//
//        if (updates.getAvailable() != null) location.setAvailable(updates.getAvailable());
//
